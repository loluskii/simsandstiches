<a data-toggle="modal" data-target="#editProduct-{{ $product->id }}" class="btn btn-sm btn-primary"> <i
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="unit_price" class="form-control" value="{{ $product->price }}"
