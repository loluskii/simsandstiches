...
<body
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #fff; margin: 0; padding: 0; width: 100%;">
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://bibahmichaels.test"
                                ...
                                <img src="https://bibahmichaels.test/2.png" class="logo" alt="Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px;">
                            </a>
                        </td>
                    </tr>
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #121212; font-size: 23px; font-weight: 500; margin-top: 0; text-align: left;">
                                        ...
                                        <p
                                            ...
                                            Hi {{ $newOrder->shipping_fname }}, we're getting your order ready to be shipped. We will notify you
                                            when it's ready to be sent out for delivery. <br> <br> Please note that during peak season, turnaround time for CUSTOM ORDERS is 2-3months, while Ready To Wear is 5-7 working days from the date of purchase, for your item to be made and prepared for shipping.</p>
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <a href="{{ route('checkout.success', $newOrder->order_reference) }}"
                                                                                class="button" target="_blank"
                                                                                rel="noopener"
                                                                                style="padding: 20px ;box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #121212;">View
                                                                                your order</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td
                                                        ...
                                                        <center>
                                                            <table class="m_1386727797541639128container"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="m_1386727797541639128subtotal-spacer"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    {{-- <tr>
                                                                                                        ...
                                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,Helvetica Neue,sans-serif;padding:5px 0"
                                                                                                            align="right">
                                                                                                            <strong
                                                                                                                style="font-size:16px;color:#555">₦138.75</strong>
                                                                                                        </td>
                                                                                                    </tr> --}}
                                                                                                </tbody>
                                                                                            </table>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; text-align: center; font-size: 14px;">
                                                        If you have any questions, reply to this email or contact us at <a href="mailto:shop.bibahmichael@gmail.com">shop.bibahmichael@gmail.com</a></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
