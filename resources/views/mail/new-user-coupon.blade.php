                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Welcome to the SimssandStitches family! 🎉 We're thrilled to have
                                                    you on board.
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    As a token of our appreciation, here's an exclusive 50% discount
                                                    just for you! Use code: <b>WELCOME50</b> at checkout to elevate your
                                                    style.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 0 24px 0;">
                                                    <a class="button" href="{{ route('shop') }}" title="Reset Password"
                                                        style="width: 100%; background: #121212; text-decoration: none; display: inline-block; padding: 20px 0; color: #fff; font-size: 18px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 2px;">SHOP
                                                        NOW</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                                    Stay tuned for more exciting updates, new arrivals, and exclusive
                            ...
                            <tr>
                                <td
                                    ...
                                    Best regards, <br><strong>The SimssandStitches Team</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                    ...
                    <div class="outlook-group-fix"
                        ...
                        <span
                            style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Simss
                            & Stitches<p>1 Hakeem Dickson Link road Lekki phase 1, Lagos<br>09055530365</p>
                    </div>
                    </div>
