...
{{-- <div class="container py-5 d-none">
	<div class="row g-5">
		...
		<div class="col-md-4">
			<div class="card position-relative">
				<img class="card-img-top" src="{{ secure_asset('images/pexels-gabriel-rodrigues-7050929.jpg') }}" alt="Title">
		...
		<div class="col-md-4">
			<div class="card position-relative">
				<img class="card-img-top" src="{{ secure_asset('images/pexels-rodnae-productions-6192585.jpg') }}" alt="Title">
